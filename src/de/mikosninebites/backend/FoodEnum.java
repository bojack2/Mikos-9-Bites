...
/**
 * FoodEnum that represents various types of food (burgers, pizzas, hotdogs),
 * each with a name, price, content and image path. Each type of food is defined
 * as a constant in all-caps with the corresponding values for its name, price
 * and image path passed as parameters to the constructor. The constructor sets
 * the values of the instance variables for each constant. The enum also
 * provides getter methods for the name, price, content and image path of each
 * product.
 * 
...
public enum FoodEnum {
	...
	/* Each product's image path */
	private final String imagePath;

	/**
	 * @param name      - each product's name
	 * @param price     - each product's price
	 * @param content   - each product's content
	 * @param imagePath - each product's image path
	 */
